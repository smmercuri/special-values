...
\begin{proof}
  ...
  This is why Definition~\ref{def:hasCriticalInteger} is not inherited by direct sums
  (Remark~\ref{rem:not-a-pkg}), and why $\zeta_K$ for $K$ imaginary quadratic has no critical
  integers.
\end{proof}
